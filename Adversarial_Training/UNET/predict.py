...
model = UNET_ORIG.build((256, 256, 3), 29, pretrained_weights='output/AdvUNET_CV.h5')
...
cv2.imwrite('adversarial_cs_unet_2.png', label_map * 255)
cv2.waitKey(0)
