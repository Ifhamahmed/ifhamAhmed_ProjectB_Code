...
model = FCN_ORIG.build((256, 256, 3), 29, pretrained_weights='FCN_8/Checkpoint_Weights_CS.h5')
...
cv2.imwrite('adv_cs_fcn_2.png', label_map * 255)
cv2.waitKey(0)
